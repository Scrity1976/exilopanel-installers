...
if [[ "$OS" = "CentOs" ]]; then
    ...
    $PACKAGE_INSTALLER php7.2-fpm php7.2-common php7.2-cli php7.2-mysql php7.2-gd php7.2-mbstring php7.2-curl php-pear php7.2-imap php7.2-xmlrpc php7.2-xsl php7.2-intl
    if [ "$VER" = "14.04" ]; then
